...
from Nets.firemoduleDet import FireDet
from Nets.resnet50ConvDet import ResNet50ConvDet

FLAGS = tf.compat.v1.flags.FLAGS

tf.compat.v1.flags.DEFINE_string('dataset', 'PASCAL_VOC',
                                 """Currently only support PASCAL_VOC dataset.""")
...
tf.compat.v1.flags.DEFINE_string('net', 'fireDet',
...
def train():
    ...
    assert FLAGS.dataset == 'PASCAL_VOC', \
        'Currently only support pascal voc dataset'
    ...
    with tf.Graph().as_default():
        ...
        assert FLAGS.net == 'vgg16' or FLAGS.net == 'resnet50' \
               or FLAGS.net == 'fireDet' or FLAGS.net == 'fire-FRD-CNN', 'Selected neural net architecture not ' \
                                                                         'supported: {}'.format(FLAGS.net)
        '''
        if FLAGS.net == 'vgg16':
