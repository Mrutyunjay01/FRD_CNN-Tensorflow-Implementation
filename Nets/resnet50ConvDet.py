...
from Utils.modelSkeleton import ModelSkeleton
...
class ResNet50ConvDet(ModelSkeleton):
    ...
    def _add_forward_graph(self):
        ...
        with tf.compat.v1.variable_scope('conv2_x') as scope:
            with tf.compat.v1.variable_scope('res2a'):
        ...
        with tf.compat.v1.variable_scope('conv4_x') as scope:
            with tf.compat.v1.variable_scope('res4a'):
                branch1 = self._conv_bn_layer(
    ...
    """
        with tf.compat.v1.compat.v1.variable_scope('res' + layer_name + '_branch2'):
